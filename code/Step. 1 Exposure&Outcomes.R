...
{#* section 1.1 NHANES III Periodontitis diagnosis ####
  {#** section 1.1.1 Data Preparation ####
    PD_dia=read.table("I:/paper_10_PD&HPL/data/NHANESIII/exam.dat",sep=",",fill=T)
  ...
  {#** section 1.1.7 data selction age>=30 ####
    adult=read.table("I:/paper_10_PD&HPL/data/NHANESIII/adult.dat",sep=",",fill=T)
    ...
    save(PD_III,file="I:/paper_10_PD&HPL/data/PD_III.Rdata")
  }
}
{#* section 1.2 NHANES 1999-2004 Periodontitis diagnosis ####
  {#** section 1.2.1 Data Preparation ####
    #periodontal_data
    OHXPER_9900<-read.xport("I:/paper_10_PD&HPL/data/PD/OHXPERIO.XPT")
    OHXPERL_0102<-read.xport("I:/paper_10_PD&HPL/data/PD/OHXPRL_B.XPT")
    OHXPERU_0102<-read.xport("I:/paper_10_PD&HPL/data/PD/OHXPRU_B.XPT")
    OHXPERL_0304<-read.xport("I:/paper_10_PD&HPL/data/PD/OHXPRL_C.XPT")
    OHXPERU_0304<-read.xport("I:/paper_10_PD&HPL/data/PD/OHXPRU_C.XPT")
  ...
  {#** section 1.2.7 data selction age>=30 ####
    ...
    save(PD_CON1,file="I:/paper_10_PD&HPL/data/PD_CON1.Rdata")
  }
}
{#* section 1.3 NHANES 2009-2014 Periodontitis diagnosis ####
  {#** section 1.3.1 Data Preparation ####
    ...
    setwd("I:/paper_10_PD&HPL/data/PD")
  ...
  {#** section 1.3.8 data selction age>=20 ####
    ...
    save(PD_CON2,file="I:/paper_10_PD&HPL/data/PD_CON2.Rdata")
  }
...
{#** Section 7.9 hyperlipoidemia  ####
  exam=read.table("I:/paper_10_PD&HPL/data/NHANESIII/exam.dat",sep=",",fill=T)
  exam$SEQN<-as.numeric(substring(exam$V1,1,5))
  adult=read.table("I:/paper_10_PD&HPL/data/NHANESIII/adult.dat",sep=",",fill=T)
  adult$SEQN<-as.numeric(substring(adult$V1,1,5))
  lab=read.table("I:/paper_10_PD&HPL/data/NHANESIII/lab.dat",sep=",",fill=T)
  ...
  save(HPL_III,file="I:/paper_10_PD&HPL/data/HPL_III.Rdata")
}
{#** Section 8.9 hyperlipoidemia  ####
  ...
  HPL_CON1<-HPL_CON
  save(HPL_CON1,file="I:/paper_10_PD&HPL/data/HPL_CON1.Rdata")
...
{#** Section 9.9 hyperlipoidemia  ####
  ...
  HPL_CON2<-HPL_CON[,c("SEQN","C")]
  save(HPL_CON2,file="I:/paper_10_PD&HPL/data/HPL_CON2.Rdata")
}
...
save(EX_III,file="I:/paper_10_PD&HPL/data/EX_III.Rdata")
...
save(EX_CON1,file="I:/paper_10_PD&HPL/data/EX_CON1.Rdata")
...
save(EX_CON2,file="I:/paper_10_PD&HPL/data/EX_CON2.Rdata")


# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 4. Periodontal status of DM patients <<<<< ####
load(file="I:/paper_10_PD&HPL/data/HPL_III.Rdata")
load(file="I:/paper_10_PD&HPL/data/HPL_CON1.Rdata")
load(file="I:/paper_10_PD&HPL/data/HPL_CON2.Rdata")
load(file="I:/paper_10_PD&HPL/data/PD_III.Rdata")
load(file="I:/paper_10_PD&HPL/data/PD_CON1.Rdata")
load(file="I:/paper_10_PD&HPL/data/PD_CON2.Rdata")
load(file="I:/paper_10_PD&HPL/data/EX_III.Rdata")
load(file="I:/paper_10_PD&HPL/data/EX_CON1.Rdata")
load(file="I:/paper_10_PD&HPL/data/EX_CON2.Rdata")
multimerge<-function(dat=list(),...){
  if(length(dat)<2)return(as.data.frame(dat))
  mergedat<-dat[[1]]
  dat[[1]]<-NULL
...
III<-multimerge(list(HPL_III,PD_III,EX_III),by="SEQN",all=T)
HPL_patient_III<-subset(III,HPL_status=="YES")
HPL_PD_III<-subset(HPL_patient_III,!is.na(PD_diagnosis))
...
CON1<-multimerge(list(HPL_CON1,PD_CON1,EX_CON1),by="SEQN",all=T)
HPL_patient_CON1<-subset(CON1,HPL_status=="YES")
HPL_PD_CON1<-subset(HPL_patient_CON1,!is.na(PD_diagnosis))
multimerge<-function(dat=list(),...){
  if(length(dat)<2)return(as.data.frame(dat))
  mergedat<-dat[[1]]
  dat[[1]]<-NULL
...
CON2<-multimerge(list(HPL_CON2,PD_CON2,EX_CON2),by="SEQN",all=T)
HPL_patient_CON2<-subset(CON2,HPL_status=="YES")
HPL_PD_CON2<-subset(HPL_patient_CON2,!is.na(PD_diagnosis))
HPL_PD<-rbind(HPL_PD_III,HPL_PD_CON1,HPL_PD_CON2)
HPL_PD_all<-subset(HPL_PD,Pregnancy=="NO")
HPL_PD_all$Pregnancy<-NULL
save(HPL_PD_all,file="I:/paper_10_PD&HPL/data/HPL_PD_all.Rdata")
save(HPL_PD_III,file="I:/paper_10_PD&HPL/data/HPL_PD_III.Rdata")
save(HPL_PD_CON1,file="I:/paper_10_PD&HPL/data/HPL_PD_CON1.Rdata")
save(HPL_PD_CON2,file="I:/paper_10_PD&HPL/data/HPL_PD_CON2.Rdata")
record<-ls()
rm(list=record[which(record!='HPL_PD_all')])
...
save(MORT_III,file="I:/paper_10_PD&HPL/data/MORT_III.Rdata")
save(MORT_CON1,file="I:/paper_10_PD&HPL/data/MORT_CON1.Rdata")
save(MORT_CON2,file="I:/paper_10_PD&HPL/data/MORT_CON2.Rdata")
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 6. Combine of PD & DM & Mortality <<<<< ####
{#* section 6.1 NHANES III Combine of data ####
  load(file="I:/paper_10_PD&HPL/data/HPL_PD_III.Rdata")
  load(file="I:/paper_10_PD&HPL/data//MORT_III.Rdata")
  III_base_mo_stat<-merge(HPL_PD_III,MORT_III,by = "SEQN",all= F)
...
{#* section 6.2 NHANES 1999-2004 Combine of data ####
  load(file="I:/paper_10_PD&HPL/data/HPL_PD_CON1.Rdata")
  load(file="I:/paper_10_PD&HPL/data/MORT_CON1.Rdata")
  CON1_base_mo_stat<-merge(HPL_PD_CON1,MORT_CON1,by = "SEQN",all.x = T)
...
{#* section 6.3 NHANES 2009-2014 Combine of data ####
  load(file="I:/paper_10_PD&HPL/data/HPL_PD_CON2.Rdata")
  load(file="I:/paper_10_PD&HPL/data/MORT_CON2.Rdata")
  CON2_base_mo_stat<-merge(HPL_PD_CON2,MORT_CON2,by = "SEQN",all.x = T)
...
save(III_baseline,file="I:/paper_10_PD&HPL/data/III_baseline.Rdata")
save(CON1_baseline,file="I:/paper_10_PD&HPL/data/CON1_baseline.Rdata")
save(CON2_baseline,file="I:/paper_10_PD&HPL/data/CON2_baseline.Rdata")
