...
{#** Section 7.6 HEI  ####
    ...
    HEI=read.table("I:/paper_10_PD&HPL/data/NHANESIII/hei.dat",sep=",",fill=T)
    ...
    load("I:/paper_10_PD&HPL/data/III_baseline.Rdata")
...
save(Covariates_III,file="I:/paper_10_PD&HPL/data/covariates_III.Rdata")
...
{#** Section 8.6 HEI  ####
    ...
    load("I:/paper_10_PD&HPL/data/CON1_baseline.Rdata")
...
save(Covariates_CON1,file="I:/paper_10_PD&HPL/data/Covariates_CON1.Rdata")
...
{#** Section 9.6 HEI  ####
    ...
    colnames(CON_HEI)[1]<-"SEQN"
    load("I:/paper_10_PD&HPL/data/CON2_baseline.Rdata")
...
save(Covariates_CON2,file="I:/paper_10_PD&HPL/data/Covariates_CON2.Rdata")
...
{#*** section 10.1 NHANES III  ####
  ...
  save(Weight_III,file="I:/paper_10_PD&HPL/data/Weight_III.Rdata")
}
{#*** section 10.2 NHANES 1999-2004  ####
  ...
  save(Weight_CON1,file="I:/paper_10_PD&HPL/data/Weight_CON1.Rdata")
}
{#*** section 10.3 NHANES 2009-2014  ####
  ...
  save(Weight_CON2,file="I:/paper_10_PD&HPL/data/Weight_CON2.Rdata")
}
...
{#* section 11.1 NHANES III  ####
  load(file="I:/paper_10_PD&HPL/data/III_baseline.Rdata")
  load(file="I:/paper_10_PD&HPL/data/Covariates_III.Rdata")
  load(file="I:/paper_10_PD&HPL/data/Weight_III.Rdata")
  multimerge<-function(dat=list(),...){
    if(length(dat)<2)return(as.data.frame(dat))
    mergedat<-dat[[1]]
    dat[[1]]<-NULL
...
{#* section 11.2 NHANES 1999-2004  ####
  load(file="I:/paper_10_PD&HPL/data/CON1_baseline.Rdata")
  load(file="I:/paper_10_PD&HPL/data/Covariates_CON1.Rdata")
  load(file="I:/paper_10_PD&HPL/data/Weight_CON1.Rdata")
  multimerge<-function(dat=list(),...){
    if(length(dat)<2)return(as.data.frame(dat))
    mergedat<-dat[[1]]
    dat[[1]]<-NULL
...
{#* section 11.3 NHANES 2009-2014  ####
  load(file="I:/paper_10_PD&HPL/data/CON2_baseline.Rdata")
  load(file="I:/paper_10_PD&HPL/data/Covariates_CON2.Rdata")
  load(file="I:/paper_10_PD&HPL/data/Weight_CON2.Rdata")
  multimerge<-function(dat=list(),...){
    if(length(dat)<2)return(as.data.frame(dat))
    mergedat<-dat[[1]]
    dat[[1]]<-NULL
...
{#* section 11.4 merge all data ####
  ...
  save(All_data,file="I:/paper_10_PD&HPL/data/All_data.Rdata")
}

# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 12. Data clearn <<<<< ####

load(file="I:/paper_10_PD&HPL/data/All_data.Rdata")
table(All_data$MDD)
All_data$HPL_status.x<-NULL
All_data$HPL_status.y<-NULL
...
Clearn_data<-All_data[,c("ID",
                         ...
                         "CVD_status","Cancer_status","HTN_status","T2D_status",
...
colname<-c("ucod_leading","Physical_status","HEI","HTN_status","CVD_status","T2D_status","Cancer_status","sdmvpsu","sdmvstra")
Characters<-colApply(Clearn_data,colname, as.factor)

save(Characters,file="I:/paper_10_PD&HPL/data/Characters.Rdata")
