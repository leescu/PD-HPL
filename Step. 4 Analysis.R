...
load(file="I:/paper_10_PD&HPL/data/Interpolation_weighted.Rdata")
...
VAR<-c("MORT_stat","CAL_mean","PPD_mean","Age","Age_status","Sex","Race_ethnicity","Education_levels","PIR",
           "Health_insurance","SEI","SES","Smoking_status","Drinking_status","Physical_status","HEI", "HTN_status",
...
save(Table1,file = "I:/paper_10_PD&HPL/data/Table1_Rdata")  
...
load(file = "I:/paper_10_PD&HPL/data/Table1_Rdata")
...
Table_1<-Table
write.table(Table_1,sep = ",",file ="I:/paper_10_PD&HPL/result/Table 1.csv" ,row.names =F,col.names =F )
}
...
Table<-rbind(Table,c("High",
                     ...
                     "" ))
Table_S3<-Table
write.table(Table_S3,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 3.csv" ,row.names =F,col.names =F )
}
...
{ #* Combine #####
  ...
  Table_2
  write.table(Table_2,sep = ",",file ="I:/paper_10_PD&HPL/result/Table 2.csv",row.names =F,col.names =F )
}
...
{ #* all model #####
  ...
  model<-svysurvreg(Surv(peryear, MORT_stat==1) ~
                      PD_diagnosis+Age_status+Sex+Race_ethnicity+SES+
                      Smoking_status+Drinking_status+BMI_status+Physical_status+
                      HTN_status+T2D_status+Cohort, design =rhcSvy,dist="weibull")
  model_result<-summary(model)
  HR<-exp(model_result[["coefficients"]][2])
  lower<-exp(model_result[["coefficients"]][2]-1.96*model_result[["table"]][,2][2])
  upper<-exp(model_result[["coefficients"]][2]+1.96*model_result[["table"]][,2][2])
...
{ #* Combine #####
  ...
  write.table(Table_3,sep = ",",file ="I:/paper_10_PD&HPL/result/Table 3.csv",row.names =F,col.names =F )
}
...
{ #* all model #####
  ...
  model3_all<-svycoxph(Surv(peryear, MORT_stat==1) ~
                         ...
                         Smoking_status+Drinking_status+BMI_status+Physical_status+
                         HTN_status+T2D_status+Cohort, design =rhcSvy)
...
{ #* section 21.3 Combine  Table 4#####
  ...
  write.table(Table_4,sep = ",",file ="I:/paper_10_PD&HPL/result/Table 4.csv" ,row.names =F,col.names =F )
...
{ #* ALL Mortality Figure 1A ####
  ...
  print(Figure_1A)
  library(eoffice)
  topptx(filename = "I:/paper_10_PD&HPL/result/Figure_1A1.pptx", width = 8, height = 6)
  ...
  print(Figure_1A)
  topptx(filename = "I:/paper_10_PD&HPL/result/Figure_1A2.pptx", width = 8, height = 6)
...
{ #* ALL Mortality Figure 1B ####
  ...
  print(Figure_1B)
  topptx(filename = "I:/paper_10_PD&HPL/result/Figure_1B.pptx", width = 8, height = 6)
...
{ #* ALL Mortality Figure 1C ####
  ...
  Figure_1C<-ggsurvplot(FIT_ALL_PD,conf.int =TRUE, fun = "cumhaz",  tables.theme = theme_cleantable(), palette=c("#0073C2E5", "#EFC000E5"), 
                        ...
                        xlab ="Time in Year",  pval =T, legend.title = "",ylim = c(0,0.2),ggtheme =  theme_calc())
  print(Figure_1C)
  topptx(filename = "I:/paper_10_PD&HPL/result/Figure_1C.pptx", width = 8, height = 6)
} 
{ #* CIF Figure 2D ##### 
  ...
  Figure_1D
  ggsave("I:/paper_10_PD&HPL/result/Figure_1D.pdf",Figure_1D,device = "pdf", width = 12, height = 6, units ="in",
...
Table_S4
write.table(Table_S4,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 4.csv",row.names =F,col.names =F )
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
data<-Interpolation_weighted[,c('peryear','MORT_stat','Cancer_MORT_stat','PD','Age_status','Sex','Race_ethnicity','SES',
                                'Smoking_status','Drinking_status','HEI','Physical_status','BMI_status','HTN_status','T2D_status','Cohort',
...
write.table(Table_S5,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 5.csv",row.names =F,col.names =F )
...
write.table(Table_S6,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 6.csv",row.names =F,col.names =F )
...
#Cbind
  ...
  write.table(Table_S7,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 7.csv",row.names =F,col.names =F )
...
write.table(Table_S8,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 8.csv",row.names =F,col.names =F )
...
write.table(Table_S9,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 9.csv",row.names =F,col.names =F )
...
{ #* all model #####
  ...
  model4<-svycoxph(Surv(peryear, MORT_stat==1) ~
                     PD_diagnosis+Age_status+Sex+Race_ethnicity+SES+
                     Smoking_status+Drinking_status+BMI_status+Physical_status+
                     HTN_status+T2D_status+Cohort+Cohort
                   , design =rhcSvy)
  model4_result<-summary(model4)
...
{ #* Combine #####
  ...
  Table_S10
  write.table(Table_S10,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 10.csv",row.names =F,col.names =F )
}
...
{ #* Combine #####
  ...
  Table_S11
  write.table(Table_S11,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 11.csv",row.names =F,col.names =F )
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 29 Original data (Table S12) ####  
load(file="I:/paper_10_PD&HPL/data/Original_weighted.Rdata")
...
{ #* section 18.5 Combine  Table S12 #####
  ...
  Table_S12<-Table
  write.table(Table_S12,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 12.csv" ,row.names =F,col.names =F )
}
...
{ #* Combine #####
  ...
  Table_S13
  write.table(Table_S13,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 13.csv",row.names =F,col.names =F )
}

# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 29 Complete data (Table S14) ####  
load(file="I:/paper_10_PD&HPL/data/Complete_weighted.Rdata")
...
{ #* section 18.5 Combine  Table S14 #####
  ...
  Table_S14<-Table
  write.table(Table_S14,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 14.csv" ,row.names =F,col.names =F )
}
...
{ #* Combine #####
  ...
  Table_S15
  write.table(Table_S15,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 15.csv",row.names =F,col.names =F )
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
{ #* Combine #####
  ...
  Table_S16
  write.table(Table_S16,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 16.csv",row.names =F,col.names =F )
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# +++++++++++++++++++Figures++++++++++++++++++++++++++ ####
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> section 32 RCS for CAL and PPD (Figure S4) ####
setwd("I:/paper_10_PD&HPL/result")
load(file="I:/paper_10_PD&HPL/data/Interpolation_weighted.Rdata")
...
{#* All cause mortarity ####
  {#** CAL_mean ####
    ...
    for (i in 3:7) {
      fit <- cph(Surv(peryear,MORT_stat) ~ rcs(CAL_mean,i)+Age_status+Sex+Race_ethnicity+SES+
                   Smoking_status+Drinking_status+BMI_status+Physical_status+
                   HTN_status+T2D_status+Cohort,data=RCS, weight= weight,family = binomial())
      tmp <- extractAIC(fit)
    ...
    text(refvalue + 0.5, 1.5, paste0("ref value = ","1.225")) 
    legend("topright",
           paste0(
  ...
  {#** PPD_mean ####
   ...
   # pdf("Supplementary Figure 4D.pdf",width=6,height=5)
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 1.2, paste0("ref value = ","1.290")) 
    legend("topright",
           paste0(
             "\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
...
{#* CVD mortarity ####
  ...
  {#** CAL_mean ####
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 1.5, paste0("ref value = ","1.244")) 
    legend("topright",
           paste0(
             "\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
  ...
  {#** PPD_mean ####
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 1.5, paste0("ref value = ","1.272")) 
    legend("topright",
           paste0(
             "\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
...
{#* Cancer mortarity ####
  ...
  {#** CAL_mean ####
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue+1, 0.8, paste0("ref value = ","1.233")) 
    legend("topright",
           paste0("\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
  ...
  {#** PPD_mean ####
    ...
    lines(x=range(pred_OR[,1]),y=c(1,1),lty=3,col="grey40",lwd=3) #
    points(refvalue,1,pch=16,cex=1)
    text(refvalue, 2, paste0("ref value = ","1.291")) 
    legend("topright",
           paste0("\nP-non-linear = ",ifelse(round(p[2],3) < 0.001,"< 0.001",round(p[2],3))),
           bty="n",cex=1)
    dev.off()
...
##### CAL #####
  ...
  {#** >=45 ####
    ...
    limDown<-quantile(RCS[,"CAL_mean"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"CAL_mean"],na.rm = T)
    RCS<- RCS[!RCS[,"CAL_mean"]>=limUp&!RCS[,"CAL_mean"]<=limDown,]
    fit <-  cph(Surv(peryear,Cancer_MORT_stat==1)~rcs(CAL_mean,4)+Sex+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
    p <-round(anova(fit)[,3],3)
    refvalue <- 	1.546
  ...
  {#** Male ####
    ...
    limDown<-quantile(RCS[,"CAL_mean"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"CAL_mean"],na.rm = T)
    RCS<- RCS[!RCS[,"CAL_mean"]>=limUp&!RCS[,"CAL_mean"]<=limDown,]
    fit <-  cph(Surv(peryear,Cancer_MORT_stat==1)~rcs(CAL_mean,4)+Age_status+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
  ...
  {#** >=45 ####
    ...
    limDown<-quantile(RCS[,"PPD_mean"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"PPD_mean"],na.rm = T)
    RCS<- RCS[!RCS[,"PPD_mean"]>=limUp&!RCS[,"PPD_mean"]<=limDown,]
    fit <-  cph(Surv(peryear,Cancer_MORT_stat==1)~rcs(PPD_mean,4)+Sex+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
  ...
  {#** Male ####
    ...
    limDown<-quantile(RCS[,"PPD_mean"],1/4,na.rm=T,names=F)-3*IQR(RCS[,"PPD_mean"],na.rm = T)
    RCS<- RCS[!RCS[,"PPD_mean"]>=limUp&!RCS[,"PPD_mean"]<=limDown,]
    fit <-  cph(Surv(peryear,Cancer_MORT_stat==1)~rcs(PPD_mean,4)+Age_status+Race_ethnicity+SES+
                  Smoking_status+Drinking_status+BMI_status+Physical_status+
                  HTN_status+T2D_status,data=RCS,x=TRUE,y=TRUE)
    anova(fit)
    cox.zph(fit, "rank")   
