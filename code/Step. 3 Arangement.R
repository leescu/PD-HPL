...
{#* section 14.1 Multiple interpolation ####
  load(file="I:/paper_10_PD&HPL/data/Characters.Rdata")
  colnames(Characters)
  mice_data<-Characters[,10:28]
  #methods(mice)
  ...
  Table_S1
  write.table(Table_S1,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 1.csv" ,row.names =F,col.names =F )
  
  init = mice(mice_data,maxit= 5, m=5,seed = 500) 
  stripplot(init)
  save(init,file="I:/paper_10_PD&HPL/data/mice_data.Rdata")
  load(file="I:/paper_10_PD&HPL/data/mice_data.Rdata")
  Interpolation_data <- cbind(Characters[,1:9],complete(init,5))
  load(file="I:/paper_10_PD&HPL/data/Characters.Rdata")
  Original_data<-Characters
  save(Original_data,file="I:/paper_10_PD&HPL/data/Original_data.Rdata")
  rownames(Original_data)<-Original_data$ID
  Original_data$ID<-NULL
  Complete_dat<-na.omit(Characters[,10:28])
  Complete_data<-cbind(Characters[rownames(Complete_dat),1:9],Complete_dat)
  save(Complete_data,file="I:/paper_10_PD&HPL/data/Complete_data.Rdata")
  save(Interpolation_data,file="I:/paper_10_PD&HPL/data/Interpolation_data.Rdata")
  
}
{#* section 14.2 Data restoration ####
  load(file="I:/paper_10_PD&HPL/data/Complete_data.Rdata")
  load(file="I:/paper_10_PD&HPL/data/Original_data.Rdata")
  load(file="I:/paper_10_PD&HPL/data/Interpolation_data.Rdata")
  {#** section 14.2.2 Original data ####
    ...
    save(Original_weighted,file="I:/paper_10_PD&HPL/data/Original_weighted.Rdata")
  }
  {#** section 14.2.1 Interpolation data ####
    ...
    save(Interpolation_weighted,file="I:/paper_10_PD&HPL/data/Interpolation_weighted.Rdata")
  }
  {#** section 14.2.2 Complete data ####
    ...
    save(Complete_weighted,file="I:/paper_10_PD&HPL/data/Complete_weighted.Rdata")
  }
...
M4 <- poLCA(formula = cbind(Education_levels,PIR,Health_insurance,SEI)~1, data = Interpolation_SES, nclass = 4, maxiter = 10000, nrep = 10, graph = F)
...
write.table(Table_S2,sep = ",",file ="I:/paper_10_PD&HPL/result/Supplementary Table 2.csv")
...
Figure_S3A
ggsave("I:/paper_10_PD&HPL/result/Supplementary Figure 3A.pdf",Figure_S3A, device = "pdf",width = 8, height = 6, units ="in",
...
Figure_S3B
ggsave("I:/paper_10_PD&HPL/result/Supplementary Figure S3B.pdf",Figure_S3B,device = "pdf", width = 8, height = 6, units ="in",
